...
echo RCView::p([], "The module " . $user_module_info->name . " has been successfully installed in the following directory: "
        . "<code>" . APP_PATH_EXTERNAL_MODULES . '/' . $user_module_info->path . "_v" . $user_module_info->version . "</code>.");
